...
public class UpdateUserPasswordController extends HttpServlet {
     ...
     */
    private static final String ERROR = "update-password.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userDAO.check(userID, oldPassword)) {
            ...
            if (newPassword.equals(retypeNewPassword)) {
                if (userDAO.updatePassword(userID, newPassword)) {
                    ...
                    request.setAttribute("warning", "Cannot change password");
                }
            } else {
                request.setAttribute("warning", "New password does not match");
            }
        } else {
            request.setAttribute("warning", "Old password not correct");
        }
