...
public class AdminUpdateProductController extends HttpServlet {
    ...
    private final String OTHER = "MainController?action=ViewUpdateProduct&productID=";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (roleID != null && roleID.equals(2)) {
            ...
            Integer productID = Integer.valueOf(request.getParameter("txtProductID"));
            ...
            if (!productDAO.update(product)) {
                request.setAttribute("warning", "Cannot update");
                url = OTHER + productID;
            } else {
                url = SUCCESS;
            }
